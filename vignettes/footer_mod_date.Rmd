...
__Note: I am hoping there is a much easier way to do this! Please let me know!__

__Note: I am doing this on the public GitHub; I have not yet tried it on GHEC.__
...
<br>
I expected that pkgdown would have this available, but I have not been successful in finding anything on this. When it comes to having dates visible on package-related documentation, I found the following in [R Packages: Chapter 17.2](https://r-pkgs.org/vignettes.html#metadata), which mentions the yaml for a vignette:
...
__Note: I have no idea what triggers .onUnload ... if someone can let me know, I would appreciate it.__


<br>
It is considered "standard" to store such code in `R/zzz.R`. Those `zzz`'s are not a placeholder; this is what I have found in my research. I was hoping that I have been the victim of a prank or outdated documentation about this, but it is mentioned in [R Packages: Chapter 6.5.4](https://r-pkgs.org/code.html?q=zzz#sec-code-onLoad-onAttach):
